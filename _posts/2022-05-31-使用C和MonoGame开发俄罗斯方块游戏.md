...
https://img2022.cnblogs.com/blog/119825/202205/119825-20220529160824095-1004399570.png
...
| 1<br><br>2<br><br>3<br><br>4<br><br>5<br><br>6<br><br>7<br><br>8<br><br>9<br><br>10<br><br>11<br><br>12<br><br>13<br><br>14<br><br>15<br><br>16<br><br>17<br><br>18<br><br>19 | `<?``xml` `version="1.0" encoding="utf-8" ?>`<br><br>`<``tetris-blocks``>`<br><br>`    ``<``blocks``>`<br><br>`        ``<``block``>`<br><br>`            ``<``name``>方块名称</``name``>`<br><br>`            ``<``description``>方块描述（可以不填）</``description``>`<br><br>`            ``<``rotations``>`<br><br>`                ``<``rotation``>`<br><br>`                    ``<``definition``>旋转形态1的描述</``definition``>`<br><br>`                ``</``rotation``>`<br><br>`                ``<``rotation``>`<br><br>`                    ``<``definition``>旋转形态2的描述</``definition``>`<br><br>`                ``</``rotation``>`<br><br>`                ``...`<br><br>`            ``</``rotations``>`<br><br>`        ``</``block``>`<br><br>`        ``...`<br><br>`    ``</``blocks``>`<br><br>`</``tetris-blocks``>` |
| --- | --- |
...
https://img2022.cnblogs.com/blog/119825/202205/119825-20220529160826389-1307000883.png
 
对于第一个形态，我们可以用一个3\*2的整型数组来表示：
 
https://img2022.cnblogs.com/blog/119825/202205/119825-20220529160827891-1666570404.png
...
| 1<br><br>2<br><br>3<br><br>4<br><br>5<br><br>6<br><br>7<br><br>8<br><br>9<br><br>10<br><br>11<br><br>12<br><br>13<br><br>14<br><br>15<br><br>16<br><br>17 | `<``block``>`<br><br>`    ``<``name``>Reversed L</``name``>`<br><br>`    ``<``rotations``>`<br><br>`        ``<``rotation``>`<br><br>`            ``<``definition``>001 111</``definition``>`<br><br>`        ``</``rotation``>`<br><br>`        ``<``rotation``>`<br><br>`            ``<``definition``>11 01 01</``definition``>`<br><br>`        ``</``rotation``>`<br><br>`        ``<``rotation``>`<br><br>`            ``<``definition``>111 100</``definition``>`<br><br>`        ``</``rotation``>`<br><br>`        ``<``rotation``>`<br><br>`            ``<``definition``>10 10 11</``definition``>`<br><br>`        ``</``rotation``>`<br><br>`    ``</``rotations``>`<br><br>`</``block``>` |
| --- | --- |

现在我们往XML里加入一个新的方块：十字方块：
 
https://img2022.cnblogs.com/blog/119825/202205/119825-20220529160829758-1233248970.png

?

| 1<br><br>2<br><br>3<br><br>4<br><br>5<br><br>6<br><br>7<br><br>8 | `<``block``>`<br><br>`    ``<``name``>Cross</``name``>`<br><br>`    ``<``rotations``>`<br><br>`        ``<``rotation``>`<br><br>`            ``<``definition``>010 111 010</``definition``>`<br><br>`        ``</``rotation``>`<br><br>`    ``</``rotations``>`<br><br>`</``block``>` |
| --- | --- |

加入十字方块后，立刻会被加载到游戏中：
 
https://img2022.cnblogs.com/blog/119825/202205/119825-20220529160833564-1427155702.png
...
> 作者:dax.net  
> 原文:https://www.cnblogs.com/daxnet/p/16324053.html  
