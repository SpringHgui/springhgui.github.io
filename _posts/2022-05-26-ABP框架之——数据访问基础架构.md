...
复合主键不能使用该IRepository&lt;TEntity, TKey&gt;接口，因为它是获取单个 PK ( Id) 类型。我们可以使用IRepository
...
- IReadOnlyRepository&lt;TEntity, TKey&gt;, IReadOnlyRepository
...
> 作者:张飞洪[厦门]
> 原文:https://www.cnblogs.com/jackyfei/p/16305833.html
